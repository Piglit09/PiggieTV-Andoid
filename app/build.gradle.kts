...
android {
    ...
    defaultConfig {
        applicationId = "com.piggietv.android"
        minSdk = 21
        targetSdk = 36
...
base.archivesName.set("piggietv-android-v${project.getVersionName()}")
...
tasks {
    ...
    register("installDebug") {
        dependsOn("installProprietaryDebug")
        group = "install"
        description = "Installs the default (Proprietary) Debug build."
    }
}
