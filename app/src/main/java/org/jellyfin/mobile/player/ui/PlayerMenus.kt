...
class PlayerMenus(
    ...
    private val reportButton: View by playerControlsBinding::toolbarReportButton
    private val fullscreenSwitcher: View by playerControlsBinding::fullscreenSwitcher
    ...
    init {
        ...
        reportButton.setOnClickListener {
            fragment.suppressControllerAutoHide(true)
            fragment.onReportMedia(reportButton)
        }
    ...
    fun onQueueItemChanged(mediaSource: JellyfinMediaSource, hasNext: Boolean) {
        ...
        val audioOnly = mediaSource.isAudioOnly
        ...
        updateSubtitlesButton()
        subtitlesButton.isVisible = !audioOnly && subtitleStreams.isNotEmpty()
        decoderButton.isVisible = !audioOnly
        fullscreenSwitcher.isVisible = !audioOnly
